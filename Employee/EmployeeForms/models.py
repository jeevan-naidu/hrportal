...
class UserDetails(models.Model):
    ...
    mobile_phone = models.IntegerField("Mobile Phone",unique=True,blank=False)
    land_phone = models.IntegerField("Landline Number", blank=True,null=True)
    emergency_phone1 = models.IntegerField("Emergency Contact Number1",unique=True,blank=True,null=True)
    emergency_phone2 = models.IntegerField("Emergency Contact Number2",unique=True,blank=True,null=True)
