...
class UserDetailsForm(forms.ModelForm):
	...
	date_of_birth.widget.attrs = {'class': 'form-control filter_class', 'readonly':'readonly', 'required':'true'}
	blood_group = forms.ChoiceField(choices=BLOOD_GROUP_CHOICES, widget=forms.Select(attrs={'class': 'input-sm form-control width-30','required': 'False'}))
	land_phone = forms.RegexField(max_length=10,required=False, regex=r'^\+?1?\d{9,15}$',
		widget=forms.TextInput(attrs={'class': 'input-sm form-control width-30','type': 'tel', 'pattern':'^\+?1?\d{9,15}$'}))
	mobile_phone = forms.RegexField(max_length=10,required=True, regex=r'^\+?1?\d{9,15}$',widget=forms.TextInput(attrs={'class': 'input-sm form-control width-30','type': 'tel', 'pattern':'^\+?1?\d{9,15}$'}))
	gender = forms.ChoiceField(choices=GENDER_CHOICES, widget=forms.Select(attrs={'class': 'input-sm form-control width-30','required': 'False'}))
...
class FamilyDetailsForm(forms.ModelForm):
	...
	employee = forms.CharField(required=False)
	marital_status = forms.ChoiceField(choices=MARITAL_CHOICES,  required=False, widget=forms.Select(attrs={'class': 'input-sm form-control width-30','required': 'False'}))
	...
	mother_dob.widget.attrs = {'class': 'form-control filter_class','readonly':'readonly'}
	...
	father_dob.widget.attrs = {'class': 'form-control filter_class','readonly':'readonly'}
...
class EducationForm(forms.ModelForm):
	...
	from_date.widget.attrs = {'class': 'form-control filter_class','readonly':'readonly', 'required':'true'}
	to_date = forms.DateField(label="To date",widget=DateTimePicker(options=dateTimeOption),)
	to_date.widget.attrs = {'class': 'form-control filter_class','readonly':'readonly','required':'true'}
...
class ProofForm(forms.ModelForm):
    ...
    # Add Bootstrap widgets
	aadhar_attachment.widget.attrs = {'class':'bare filestyle', 'data-buttonBefore':'true', 'data-iconName':'glyphicon glyphicon-paperclip'}
    ...
    # Add Bootstrap widgets
	dl_attachment.widget.attrs = {'class':'bare filestyle', 'data-buttonBefore':'true', 'data-iconName':'glyphicon glyphicon-paperclip'}
    ...
    # Add Bootstrap widgets
	passport_attachment.widget.attrs = {'class':'bare filestyle', 'data-buttonBefore':'true', 'data-iconName':'glyphicon glyphicon-paperclip'}
    ...
    # Add Bootstrap widgets
	voter_attachment.widget.attrs = {'class':'bare filestyle', 'data-buttonBefore':'true', 'data-iconName':'glyphicon glyphicon-paperclip'}
